...
from etl.ddl import adapt_schema, reset_database, syncronyze_extensions
...
def test_move_schema(database: Engine, destination: Engine):
    # syncronyze public
    ...
    assert len(total_tables) == len(final_tables) == 4
